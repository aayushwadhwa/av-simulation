...
class RolloutStorage(object):
    ...
    def insert(self, obs, delta, delta_log_prob, value_pred, obs_feat=None):
    ...
    def feed_forward_generator(self, advantages = None, mini_batch_size=None):
        ...
        for indices in sampler:
            ...
            yield obs_batch, delta_batch, return_batch, old_delta_log_probs_batch, adv_targ, obs_feat_batch, next_obs_feat_batch
